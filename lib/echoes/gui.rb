...
module Echoes
  class GUI
    ...
    def initialize(command: Echoes.config.shell, rows: Echoes.config.rows, cols: Echoes.config.cols, font_size: nil)
      ...
      @tab_fg = nil
      @selection_color = nil
      @search_match_color = nil
      @search_current_color = nil
      ...
      @marked_text = nil
      @current_event = nil
      @pane_divider_color = nil
      @active_pane_border_color = nil
      @copy_mode_cursor_color = nil
      @window_states = []
      @view_to_ws = {}
    end

    def run
      @window ||= self.class.window_class.new(self, command: @command, rows: @rows, cols: @cols, font_size: @font_size)
